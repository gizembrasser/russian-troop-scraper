...
data <- read.csv("../data/clean/2023_troepen_EN.csv", header = TRUE, stringsAsFactors = FALSE)
...
ggplot(changes_df, aes(x = Date2, y = Changes)) +
  geom_line() +
  labs(title = "Aantal Russische troepenverplaatsingen per maand (2023)", x = "", y = "Verplaatsingen (boven 10 km)") +
